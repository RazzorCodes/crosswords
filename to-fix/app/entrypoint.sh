...
echo "Starting release server with APP_MODE=${APP_MODE} MODEL_BASE_URL=${CLIENT_MODEL_BASE_URL} upstream=${UPSTREAM_MODEL_BASE_URL:-local} srv=${FINAL_SRV_URL:-disabled}"
